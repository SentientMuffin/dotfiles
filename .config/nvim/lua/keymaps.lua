...
vim.keymap.set('n', 'q', 'viwo<esc>?\\<<cr>', {desc = 'Beginning of previous word'})
vim.keymap.set('n', 'Q', 'viwo<esc>?\\<<cr>viw<esc>', {desc = 'End of previous word'})
vim.keymap.set('v', 'q', '?\\<<cr>', {desc = 'Beginning of previous word'})
vim.keymap.set('v', 'Q', '?\\<<cr>e', {desc = 'End of previous word'})
